...
class ViewController: UIViewController {
    ...
    @IBAction func shrinky(_ sender: Any) {
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            self.centreShrinkyButton.startAnimating(at: .centre(shrink: true))
    ...
    @IBAction func centreAction(_ sender: Any) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
            self.centreButton.startAnimating(at: .centre(shrink: false))
            DispatchQueue.main.asyncAfter(deadline: .now() + 1.5) {
    ...
    @IBAction func trailingAction(_ sender: Any) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            self.trailingLoader.startAnimating(at: .trailing(offset: 15, titleWhileLoading: nil))
            DispatchQueue.main.asyncAfter(deadline: .now() + 1.5) {
    ...
    @IBAction func trailingActionWithText(_ sender: Any) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            self.trailingLoaderWithTextButton.startAnimating(at: .trailing(offset: 15, titleWhileLoading: "Loading"))
            DispatchQueue.main.asyncAfter(deadline: .now() + 1.5) {
    ...
    @IBAction func leadingAction(_ sender: Any) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            self.leadingLoaderButton.startAnimating(at: .leading(offset: 15, titleWhileLoading: nil))
            DispatchQueue.main.asyncAfter(deadline: .now() + 1.5) {
    ...
    @IBAction func leadingActionWithText(_ sender: Any) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            self.leadingLoaderWithTextButton.startAnimating(at: .leading(offset: 15, titleWhileLoading: "Loading"))
            DispatchQueue.main.asyncAfter(deadline: .now() + 1.5) {
